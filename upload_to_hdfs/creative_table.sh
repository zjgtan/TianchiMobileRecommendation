...
do
    hive -e "
    ALTER TABLE sycpb.tmp_mobile_recommendation_user_behavoir ADD PARTITION (log_date=\"${start_date}\") LOCATION \"viewfs://jssz-bigdata-cluster/department/buss_product/chenjiawei/mobile_recommendation/tianchi_fresh_comp_train_user/log_date=${start_date}\"
    "
